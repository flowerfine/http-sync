...
public class SwaggerConfigs {
    ...
    private Info apiInfo() {
        return new Info()
                .title("Http-Sync API文档")
                .description("Http-Sync API文档")
                .version("0.0.1-SNAPSHOT")
                .termsOfService("https://flowerfine.github.io/http-sync/zh")
                .license(new License().name("Apache 2.0").url("https://github.com/flowerfine/http-sync/blob/dev/LICENSE"))
                .contact(contact());
    }
