...
import cn.sliew.http.workflow.temporal.workflow.dsl.model.WorkflowData;
import cn.sliew.http.workflow.temporal.workflow.dsl.util.DslWorkflowUtils;
import cn.sliew.http.workflow.temporal.workflow.dsl.util.JQFilter;
...
public class DynamicDslWorkflow implements DynamicWorkflow {
    ...
    public Object execute(EncodedValues args) {
        ...
        dslWorkflow = ServerlessWorkflowCache.getWorkflow(dslWorkflowId, dslWorkflowVersion);
